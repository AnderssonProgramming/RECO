...
Welcome to the repository for **RECO** (Redes de Computadores - Computer Networks) at the *Escuela Colombiana de Ingeniería Julio Garavito*.
This comprehensive collection showcases the complete journey through computer networking fundamentals, infrastructure management, and network protocols — exploring the intersection of network architecture, system administration, and modern cloud technologies 🚀.
...
**Key Files**:
* Shell Scripts: [user_group_creation.sh](FIRST%20TERM/labs/lab-02/user_group_creation.sh), [file_search_menu.sh](FIRST%20TERM/labs/lab-02/file_search_menu.sh), [log_review_menu.sh](FIRST%20TERM/labs/lab-02/log_review_menu.sh)
* DNS Configuration: [DNS_Configurations/](FIRST%20TERM/labs/lab-03/Lab.%20No.03/DNS_Configurations/)
* Packet Tracer Files: [andersson.pkt](FIRST%20TERM/labs/lab-02/andersson.pkt), [cristian.pkt](FIRST%20TERM/labs/lab-02/cristian.pkt)
* Lab Guides: [lab03_guide.md](FIRST%20TERM/labs/lab-03/Lab.%20No.03/lab03_guide.md)
...
**Key Files**:
* Packet Tracer Simulations: [andersson.pkt](FIRST%20TERM/labs/lab-02/andersson.pkt), [cristian lab6.pkt](SECOND%20TERM/labs/lab-06/cristian%20lab6.pkt)
* Reports: [Lab04_Report.tex](SECOND%20TERM/labs/lab-04/Lab04_Report.tex), [Lab05_Report.tex](SECOND%20TERM/labs/lab-05/Lab05_Report.tex), [lab06_report.tex](SECOND%20TERM/labs/lab-06/lab06_report.tex)
...
**Key Files**:
* Network Scripts: [slack_network_script.sh](THIRD%20TERM/labs/lab07/slack_network_script.sh), [solaris_network_script.sh](THIRD%20TERM/labs/lab07/solaris_network_script.sh), [slackware_network_info.sh](THIRD%20TERM/labs/lab08/slackware_network_info.sh)
* Packet Tracer Projects: [VLAN_Sanchez_Andersson-Cristian.pkt](THIRD%20TERM/labs/lab08/VLAN_Sanchez_Andersson-Cristian.pkt), [Wifi_Andersson-Cristian.pkt](THIRD%20TERM/labs/lab08/Wifi_Andersson-Cristian.pkt), [Switches.pkt](THIRD%20TERM/labs/lab08/Switches.pkt)
* Router Configurations: [router-configuration.cfg](THIRD%20TERM/labs/lab08/router-configuration.cfg)
* Technical Essays: [vlan_configuration_guide.tex](THIRD%20TERM/labs/lab08/essays/vlan_configuration_guide.tex), [wifi_configuration_guide.tex](THIRD%20TERM/labs/lab08/essays/wifi_configuration_guide.tex), [ieee_article.tex](THIRD%20TERM/labs/lab08/essays/ieee_article.tex)
* Reports: [lab07_report.tex](THIRD%20TERM/labs/lab07/lab07_report.tex), [lab08_report.tex](THIRD%20TERM/labs/lab08/lab08_report.tex)
* Final Lab Guide: [Guia_Laboratorio_Redes_OSPF_VLANs.pdf](THIRD%20TERM/labs/lab09/Guia_Laboratorio_Redes_OSPF_VLANs.pdf)
...
<p align="center">
  <img src="https://cdn-icons-png.flaticon.com/512/2821/2821666.png" width="65px" />
  <img src="https://media.licdn.com/dms/image/v2/D560BAQFYnR_Zrm87Dg/company-logo_200_200/B56ZnMyVr4HUAI-/0/1760077372453/cisco_logo?e=2147483647&v=beta&t=wMRlDk1RRcz8v2MnLi-WNQ-07NQIVXIdK096CqgMa14" width="65px" style="margin-left: 20px;"/>
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg" width="65px" style="margin-left: 20px;" />
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bash/bash-original.svg" width="65px" style="margin-left: 20px;" />
  <img src="https://www.vectorlogo.zone/logos/cisco/cisco-icon.svg" width="65px" style="margin-left: 20px;" />
</p>
...
💌 **[andersson.sanchez-m@mail.escuelaing.edu.co](mailto:andersson.sanchez-m@mail.escuelaing.edu.co)** — Let's build networks that connect possibilities!
...
<p align="center">
  Made with 💙 at Escuela Colombiana de Ingeniería Julio Garavito
</p>
